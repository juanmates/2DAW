...
import com.ej07.service.ClienteService;
...
/*
	...
	@GetMapping("/buscarPorCiudadB/{ciudad}")
    public ResponseEntity<List<Cliente>> getClientesByCiudadB(@PathVariable String ciudad) {
        List<Cliente> clientes = clienteService.findClientesByCiudadB(ciudad);
        System.out.println(clientes.size());
        if (clientes.isEmpty()) {
            return ResponseEntity.noContent().build();
        }
	...
	@GetMapping("/buscarPorCiudadC/{ciudad}")
    public ResponseEntity<List<Direccion>> getClientesByCiudadC(@PathVariable String ciudad) {
        List<Direccion> direcciones = clienteService.findClientesByCiudadC(ciudad);
