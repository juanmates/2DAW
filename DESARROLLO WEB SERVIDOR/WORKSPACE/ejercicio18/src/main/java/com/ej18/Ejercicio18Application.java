...
import com.ej18.service.PersonaService;
...
public class Ejercicio18Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        servicio.asignarPasaporte(persona1, pasaporte1);
        servicio.asignarPasaporte(persona2, pasaporte2);

        // Asignar proyectos a personas
        servicio.agregarProyecto(persona1, proyecto1);
        
        servicio.agregarProyecto(persona1, proyecto2);
        servicio.agregarProyecto(persona2, proyecto1);
        ...
        servicio.eliminarProyecto(persona1, proyecto2);

        // Obtener los datos actualizados de persona1
        Optional<Persona> personaActualizada = servicio.obtenerPorId(persona1.getId());
        if(personaActualizada!=null) {
        System.out.println("Persona actualizada: " + personaActualizada.get().getNombre());
        personaActualizada.get().getProyectos().forEach(pr -> System.out.println("  Proyecto: " + pr.getNombre()));
        }
    }
}
