    ...
    !(function(t, e) {
      ...
      class W {
        ...
        _mergeConfigObj(t2, e2) {
          ...
          return __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, this.constructor.Default), "object" == typeof i2 ? i2 : {}), r(e2) ? H.getDataAttributes(e2) : {}), "object" == typeof t2 ? t2 : {});
        }
      ...
      class Qi extends B {
        ...
        _getPopperConfig() {
          ...
          return (this._inNavbar || "static" === this._config.display) && (H.setDataAttribute(this._menu, "popper", "static"), t2.modifiers = [{ name: "applyStyles", enabled: false }]), __spreadValues(__spreadValues({}, t2), _(this._config.popperConfig, [void 0, t2]));
        }
      ...
      class ps extends B {
        ...
        _getTemplateFactory(t2) {
          return this._templateFactory ? this._templateFactory.changeContent(t2) : this._templateFactory = new es(__spreadProps(__spreadValues({}, this._config), { content: t2, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
        }
        ...
        _getPopperConfig(t2) {
          ...
          return __spreadValues(__spreadValues({}, e2), _(this._config.popperConfig, [void 0, e2]));
        }
        _setListeners() {
      ...
      g(ps);
      const ms = ".popover-header", gs = ".popover-body", _s = __spreadProps(__spreadValues({}, ps.Default), { content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click" }), bs = __spreadProps(__spreadValues({}, ps.DefaultType), { content: "(null|string|element|function)" });
      class vs extends ps {
        static get Default() {
          return _s;
        }
